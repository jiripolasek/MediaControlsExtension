...
internal static class IconThemeCatalog
{
    ...
    public static IReadOnlyList<IconRequest> RequiredIcons { get; } =
        ...
        new(ThemedIcon.VolumeZero),
        new(ThemedIcon.VolumeUnmute),
    ...
    private static Dictionary<IconRequest, string> CreateFluentOutlineIcons()
    {
        return new()
        {
            ...
            [new(ThemedIcon.VolumeZero)] = SegoeFluentIconGlyphs.VolumeZero,
            [new(ThemedIcon.VolumeUnmute)] = SegoeFluentIconGlyphs.VolumeUnmute,

...
internal static class WorkerApplication
{
    ...
    private static async Task<int> RunBackendAsync(string pipe, Guid ownerId, int processId, string backendId, WorkerBackendFactory factory)
    {
        ...
        try
        {
            return await MediaBackendHost.RunAsync(pipe, ownerId, processId, backendId, context =>
            {
                ...
                memory = new(16 * 1024 * 1024, logging.CreateLogger<ProcessMemoryMaintenance>());
